...
using SalesWebMvc.Models; // for SalesWebMvcContext
...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        // When a SeedingService is created, it will automatically receive an instance of the Context
        public SeedingService(SalesWebMvcContext context)
        {
            _context = context;
        }

        // Responsible for entering data into the database if it is empty
        public void Seed()
        {
            ...
            Seller s6 = new Seller { Id = 6, Name = "Alex Pink", Email = "bob@gmail.com",
                            BirthDate = new DateTime(1997, 3, 4), BaseSalary = 3000.0, Department = d2 };
            ...
            SalesRecord r30 = new SalesRecord { Id = 30, Date = new DateTime(2018, 10, 12), Amount = 5000.0,
                                Status = SaleStatus.Billed, Seller = s2 };
